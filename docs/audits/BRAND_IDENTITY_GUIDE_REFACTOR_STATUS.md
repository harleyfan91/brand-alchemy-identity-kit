...
- **Wide column:**
  ...
  - Exactly one framing body below:
    ...
    - **One-line brand statement** (`positioning.oneLine`, mirror of `summary.oneLine`) rendered as a larger quote panel when no story qualifies. When `storyNote` is present, `oneLine` is omitted.
