...
|---|---|---|
| **Price** | $79 | $149 |
| **Positioning** | Foundational brand layer that makes downstream execution tools easier to use well | Foundation plus ready-to-use messaging assets with deeper strategy/voice tailoring |
