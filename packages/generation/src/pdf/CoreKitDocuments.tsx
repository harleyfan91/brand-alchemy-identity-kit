...
function createCoreKitStyles(bodyFamily: string, displayFamily: string) {
  ...
  /** Strategy Memo §7 — vertical timeline spine + node cards. */
  guideRoadmapLayout: {
    flexDirection: 'row',
    alignItems: 'flex-start',
  },
  ...
  guideRoadmapSpineDotMuted: {
    borderColor: '#D4D4D8',
    backgroundColor: '#F4F4F5',
  },
  guideRoadmapSpineConnector: {
    width: 1,
    flexGrow: 1,
    minHeight: 10,
  ...
  guideRoadmapNodeCardCol: {
    flex: 1,
    minWidth: 0,
    paddingBottom: 8,
  },
  guideRoadmapNodeCard: {
    borderWidth: 1,
    borderColor: '#E4E4E7',
    borderRadius: 6,
    paddingVertical: 6,
