...
const INDUSTRY_VOICE: Record<string, IndustryVoiceProfile> = {
  ...
  health_wellness: {
    ...
    toneModifier:
      'In health and wellness especially, credibility comes from specificity. Focus on what you help people achieve, not how fast.',
  ...
  food_beverage: {
    ...
    toneModifier:
      'Food brands earn trust through transparency: what is in it, where it came from, and how it was made.',
  },
  fitness_sports: {
    ...
    toneModifier:
      'Fitness brands are most credible when they show real people doing real work. Keep the energy, and be honest about the effort.',
  ...
  beauty_personal_care: {
    ...
    toneModifier:
      'Beauty and personal care readers want honesty about what a product does and what it contains. Aim for confidence without impossible promises.',
