...
> **Platform register reminders (carry through every pair):**
> - Platform-native mechanics: DM, link in bio, comment, tap, save, drop a DM
> - Fragments are natural — no period needed after a short declarative fragment in caption context
> - Bold: keyword trigger mechanics (DM 'X', Comment 'Y'), fast and decisive
> - Friendly: warm invitation, "we're real people," reply-with-warmth tone
> - Scarcity for `retail_maker`: "get them before they're gone" — not anthropomorphized ("they don't last long" is OK; "they won't stick around" is not)
> - `community`: purpose and belonging register throughout — no transactional efficiency language

---

## Existing bank fixes — action items before applying Wave D

Two issues in the existing Social Casual base pairs require a Wave A-style fix:

1. **Line 1393 — format anomaly** (`retail_maker > audience_growth > bold > pair 3`):
   ```
   ["Save this and follow. New things every week, everything made by hand."]
   ```
   Parses as single-element array. Recommended fix:
   ```
   ["Save this and follow.", "New things every week, everything made by hand. Get them before they're gone."]
   ```

2. **Line 1227 — register slip** (`community > direct_sales > bold > pair 3`):
   ```
   ["Link in bio to sign up!", "Takes 30 seconds."]
   ```
   Transactional efficiency language is off-register for community. Recommended fix:
   ```
   ["Tap the link and find your place in the work.", "Every kind of contribution matters."]
   ```
...
### SOCIAL > `direct_sales` > `trades_home` > bold
...
["Comment 'ESTIMATE' and I'll reach out with next steps.", "Fast, honest, no obligation."],
...
### SOCIAL > `direct_sales` > `trades_home` > friendly

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Tap the link in bio and book a free estimate.", "We're local and we get back to everyone fast."],
["Drop a DM and we'll take a look at the job.", "We'll give you an honest read on what it needs."],
["DM us the details and we'll put together an estimate.", "Straight quotes. No surprise additions."],
...
### SOCIAL > `direct_sales` > `food_hospitality` > bold
...
### SOCIAL > `direct_sales` > `food_hospitality` > friendly
...
### SOCIAL > `direct_sales` > `retail_maker` > bold
...
["Tap the link in bio. New pieces just dropped.", "Handmade, limited. Go now."],
...
### SOCIAL > `direct_sales` > `retail_maker` > friendly
...
["Link in bio to shop the new pieces.", "Small batch. Grab yours while they're here."],
...
### SOCIAL > `direct_sales` > `health_wellness` > bold
...
### SOCIAL > `direct_sales` > `health_wellness` > friendly

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Tap the link and pick a time that works.", "Morning, afternoon, and evening available."],
["Book your appointment through the link in bio.", "New clients are always welcome here."],
...
### SOCIAL > `direct_sales` > `creative_pro` > bold
...
["Tap the link to see recent work, then DM if something connects.", "Quick replies, always."],
...
### SOCIAL > `direct_sales` > `creative_pro` > friendly
...
["Tap the link to see the portfolio. DM if it resonates.", "No formal process to get started."],
...
### SOCIAL > `direct_sales` > `professional_svc` > bold
...
["Tap the link to book a free consult.", "You'll leave knowing exactly where you stand."],
...
### SOCIAL > `direct_sales` > `professional_svc` > friendly

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["DM us and we'll set up a free conversation.", "We talk like real people. No jargon."],
["Tap the link to book a free call.", "We'll listen first and give you a straight answer."],
...
### SOCIAL > `direct_sales` > `community` > bold

_Existing pairs 1–3 unchanged (pair 3 flagged above — fix recommended before applying Wave D)._
...
### SOCIAL > `direct_sales` > `community` > friendly
...
["DM us if you want to be part of what we're building.", "We'll find the right fit together."],
...
### SOCIAL > `lead_gen` > `trades_home` > bold
...
```
["DM a photo and what you need done. I'll get back to you with a price.", "Same-day response."],
["Comment 'QUOTE' and I'll reach out with next steps.", "Fast, honest, no obligation."],
...
### SOCIAL > `lead_gen` > `trades_home` > friendly
...
["Drop a DM with the details.", "We'll give you a clear picture of what's involved."],
...
### SOCIAL > `lead_gen` > `food_hospitality` > bold
...
["DM 'EVENT' and I'll reply with menus and pricing today.", "Every occasion, every size."],
...
### SOCIAL > `lead_gen` > `food_hospitality` > friendly
...
["Tell us about the occasion in a DM.", "We'll come back with some options that fit."],
...
### SOCIAL > `lead_gen` > `retail_maker` — NEW SECTION
...
### SOCIAL > `lead_gen` > `health_wellness` > bold
...
### SOCIAL > `lead_gen` > `health_wellness` > friendly
...
["Drop a DM. We'll set up a free first chat and figure out if we're a fit.", "First conversation is always free."],
```

---

### SOCIAL > `lead_gen` > `creative_pro` > bold
...
### SOCIAL > `lead_gen` > `creative_pro` > friendly

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["DM us about the project, even just a sentence.", "We love early-stage conversations."],
...
["Tell us what you're building in a DM.", "If it sounds like a fit, we'll get back to you the same day."],
["Tap the link to see our work. DM if it feels right.", "We make it easy to start a project."],
```

---

### SOCIAL > `lead_gen` > `professional_svc` > bold
...
["Comment 'CALL' and I'll DM my availability.", "First consultation is on us."],
...
### SOCIAL > `lead_gen` > `professional_svc` > friendly
...
["Send a DM and we'll set up a free call.", "Honest answers. No runaround."],
```

---

### SOCIAL > `lead_gen` > `community` > bold
...
### SOCIAL > `lead_gen` > `community` > friendly
...
## Goal: `retention` — Social Casual, per industry

The existing bank has a single shared 3-pair retention block (no industry or tone split). Wave D establishes per-industry pairs. The existing shared pairs remain as a fallback; these new blocks take priority when the industry is known.

---

### SOCIAL > `retention` > `trades_home`
...
### SOCIAL > `retention` > `food_hospitality`

**New pairs 4–8:**
```
["New menu items since you last came in.", "Tap the link to see what's on."],
["It's been a while. Come back and see what's changed.", "We'd love to have you in."],
["We're still here, still cooking. Come find us.", "Link in bio to reserve or order."],
["The menu's changed since your last visit.", "Come back and try what's new."],
["We miss the regulars. Come in and see what's on.", "Tap the link to book or order."],
```

---

### SOCIAL > `retention` > `retail_maker`
...
### SOCIAL > `retention` > `health_wellness`

**New pairs 4–8:**
```
["Ready to pick it back up?", "Tap the link and book your next session."],
["New slots just opened up.", "Good time to get back on track. Tap the link."],
["We're still here when you're ready to come back.", "Tap the link to book."],
["Your history is on file. Easy to pick up right where you left off.", "Tap the link to book your next session."],
["When you're ready, we're ready.", "Tap the link and find a time."],
```

---

### SOCIAL > `retention` > `creative_pro`

**New pairs 4–8:**
```
["Something new in the pipeline?", "DM us and let's pick it up."],
["Working on a new project? We'd love to be involved.", "DM the brief."],
["We've done some great work since we last worked together.", "Tap the link to see it."],
["Have something new coming up? Get in early.", "DM us and let's talk timing."],
["Still making things. If you have a project coming up, we're interested.", "DM or tap the link in bio."],
```

---

### SOCIAL > `retention` > `professional_svc`

**New pairs 4–8:**
```
["Something changed in your situation?", "DM us and we'll set up a quick call."],
...
**New pairs 4–8:**
```
["Still believe in the work? Come back and get involved.", "Tap the link to see what's new."],
["We've grown since you were last with us.", "More to do, more ways to help. Tap the link."],
["Ready to get back involved? We'd love to have you.", "DM us or tap the link."],
["New programs have launched since you were last here.", "Tap the link to see how to get involved."],
["The work is still happening. Come be part of it.", "DM us or tap the link in bio."],
```
...
| Goal | Industry | Tones × new pairs | New pairs |
|---|---|---|---:|
| `direct_sales` | `trades_home` | 2 × 5 | 10 |
| `direct_sales` | `food_hospitality` | 2 × 5 | 10 |
| `direct_sales` | `retail_maker` | 2 × 5 | 10 |
| `direct_sales` | `health_wellness` | 2 × 5 | 10 |
| `direct_sales` | `creative_pro` | 2 × 5 | 10 |
| `direct_sales` | `professional_svc` | 2 × 5 | 10 |
| `direct_sales` | `community` | 2 × 5 | 10 |
| **`direct_sales` subtotal** | | | **70** |
| `lead_gen` | `trades_home` | 2 × 5 | 10 |
| `lead_gen` | `food_hospitality` | 2 × 5 | 10 |
| `lead_gen` | `retail_maker` **NEW** | 2 × 8 | 16 |
| `lead_gen` | `health_wellness` | 2 × 5 | 10 |
| `lead_gen` | `creative_pro` | 2 × 5 | 10 |
| `lead_gen` | `professional_svc` | 2 × 5 | 10 |
| `lead_gen` | `community` | 2 × 5 | 10 |
| **`lead_gen` subtotal** | | | **76** |
| `retention` | `trades_home` | 1 × 5 | 5 |
| `retention` | `food_hospitality` | 1 × 5 | 5 |
| `retention` | `retail_maker` | 1 × 5 | 5 |
| `retention` | `health_wellness` | 1 × 5 | 5 |
| `retention` | `creative_pro` | 1 × 5 | 5 |
| `retention` | `professional_svc` | 1 × 5 | 5 |
| `retention` | `community` | 1 × 5 | 5 |
| **`retention` subtotal** | | | **35** |
| **WAVE D TOTAL** | | | **181** |

---

_Wave E covers narrator-tuned variants for the six industry × narrator pairs identified in §4C of the audit. Wave F covers marketplace TODOs and Tier-2 depth on the remaining surfaces._
