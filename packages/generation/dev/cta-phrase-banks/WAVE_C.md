...
Two missing EMAIL `lead_gen` sections are established here from scratch: `retail_maker` and `community`.

> **Audience growth shapes** for each industry are defined inline at the `audience_growth` heading. The creative framework (§13 Wave C in the audit) is resolved here before pair-writing begins for each industry.

---

---

## Industry: `retail_maker`

Register: **scarcity, craft, materiality, maker-to-buyer directness, early access.**
Bold: product-forward, concise, FOMO-adjacent without being cheap about it.
Friendly: warm, personal, behind-the-counter access, the joy of owning something handmade.
Professional: transactional but craft-aware; trade/wholesale vocabulary.

---

### WEBSITE > `direct_sales` > `retail_maker` > bold

_Existing pairs 1–3 unchanged._
...
### WEBSITE > `direct_sales` > `retail_maker` > friendly
...
### WEBSITE > `direct_sales` > `retail_maker` > professional
...
### WEBSITE > `lead_gen` > `retail_maker` > bold
...
### WEBSITE > `lead_gen` > `retail_maker` > friendly
...
### WEBSITE > `lead_gen` > `retail_maker` > professional
...
["Contact us to discuss a custom fabrication or wholesale arrangement.", "We will respond with pricing and production lead times within two business days."],
["Submit a custom order or volume inquiry.", "All custom work begins with a written scope and quoted price. No commitment to inquire."],
...
### WEBSITE > `audience_growth` > `retail_maker`

**Shapes for `retail_maker` audience_growth:**
- **Drop notification (D):** follow to not miss the moment stock goes live — small batches, no restocks
- **Process/craft access (P):** see how things are made, before they're in the shop
- **Material sourcing (M):** where the materials come from, what goes into choosing them
- **Pre-launch preview (L):** see what's coming before it's available to anyone
- **First-to-shop (F):** the mailing list is how you actually get one

#### bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8 (shapes: F, P, D+F, M, D):**
```
["Follow and you'll know first.", "New drops go live here before anywhere else. Small batches, no restocks."],
["Follow and see how each piece comes to life.", "We post the full process — raw material to finished piece — before every drop."],
...
**New pairs 4–8 (shapes: P, F+D, L+P, M+P, F):**
```
...
**New pairs 4–8 (shapes: F+L, D, F+M, L+P, F+D):**
```
...
### WEBSITE > `retention` > `retail_maker`
...
### EMAIL > `direct_sales` > `retail_maker` > bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Reply with what you want. I'll pull it from the shelf and ship it this week.", "Everything in stock ships within two days."],
...
### EMAIL > `direct_sales` > `retail_maker` > friendly
...
### EMAIL > `direct_sales` > `retail_maker` > professional
...
["Reply with your order and we will confirm availability and send an invoice.", "Returns accepted within 30 days of delivery with original packaging."],
```

---

### EMAIL > `lead_gen` > `retail_maker` — NEW SECTION

_No existing pairs. All 8 pairs per tone established here._
...
### EMAIL > `audience_growth` > `retail_maker`
...
Register: **ease, care, non-judgment, concrete progress, "just start."**
Bold: decisive, clear next step, urgency framed around availability not pressure.
Friendly: welcoming, low-pressure, "just a conversation" framing, warmth without being sentimental.
Professional: clinical credibility, structured intake, evidence-based positioning.

---

### WEBSITE > `direct_sales` > `health_wellness` > bold
...
["Book your appointment. Takes about a minute.", "New and returning clients. Same-week availability."],
["Open your calendar and find a time that works.", "We'll take care of the rest when you arrive."],
```

---

### WEBSITE > `direct_sales` > `health_wellness` > friendly
...
### WEBSITE > `direct_sales` > `health_wellness` > professional
...
["Request an appointment at a time that suits you.", "Morning, afternoon, and evening availability for new and returning clients."],
...
### WEBSITE > `lead_gen` > `health_wellness` > bold
...
### WEBSITE > `lead_gen` > `health_wellness` > friendly
...
### WEBSITE > `lead_gen` > `health_wellness` > professional
...
### WEBSITE > `audience_growth` > `health_wellness`

**Shapes for `health_wellness` audience_growth:**
- **Practical tip (T):** one immediately applicable idea — not a course, not a program
- **Myth-bust/reframe (M):** challenging common misconceptions with clinical authority
- **What-works (W):** specific to what professionals actually observe, not generic wellness content
- **Evidence-backed (E):** grounded in research, not influencer culture — "we cite our sources"
- **Before-you-need-us (B):** follow now so when the moment arrives they know who to call

#### bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8 (shapes: T, W, M, B, T):**
```
...
**New pairs 4–8 (shapes: M, T+E, W, T, E):**
```
...
**New pairs 4–8 (shapes: E, W+E, M+E, E, T+E):**
```
...
### WEBSITE > `retention` > `health_wellness`
...
### EMAIL > `direct_sales` > `health_wellness` > bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Reply and I'll hold the next available slot.", "Tell me morning, afternoon, or evening. I'll sort it."],
...
["Reply 'BOOK' and I'll send the scheduling link.", "I'll also send a brief intake form so we make the most of your first session."],
```

---

### EMAIL > `direct_sales` > `health_wellness` > friendly
...
["Hit reply and I'll check availability.", "Morning, afternoon, and evening slots — tell me what works for you."],
...
### EMAIL > `direct_sales` > `health_wellness` > professional
...
### EMAIL > `lead_gen` > `health_wellness` > bold
...
### EMAIL > `lead_gen` > `health_wellness` > friendly
...
["Reply with what you're hoping to change.", "We'll have a free conversation and figure out whether we're a good fit."],
...
### EMAIL > `lead_gen` > `health_wellness` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Please reply with a summary of your goals and current situation.", "We will respond with a recommended starting point and available consultation times."],
["Reply to request a complimentary consultation.", "We will confirm timing and send a brief intake form in advance."],
...
["Please reply with your goals and any relevant background.", "We will respond within one business day with recommended next steps."],
...
### EMAIL > `audience_growth` > `health_wellness`
...
### EMAIL > `retention` > `health_wellness`

_Existing pairs 1–3 unchanged._

**New pairs 4–6:**
```
["Ready to book your next session? Reply and I'll check availability.", "We'll pick up right where we left off."],
["Time for a check-in? Reply with a couple of days that work.", "Your history is on file — no need to start over."],
...
## Industry: `creative_pro`

Register: **craft, selectivity, portfolio-first trust, collaboration between equals, limited capacity.**
Bold: portfolio → inquiry, declarative about availability and response time.
Friendly: conversational, relationship-oriented, "tell us what you're building" — no formality required.
Professional: proposal-driven, scope and timeline discipline, written commitment culture.

---

### WEBSITE > `direct_sales` > `creative_pro` > bold
...
["View the portfolio. Start a conversation.", "We take on a small number of new projects each quarter."],
["See recent work. Start a project.", "We're selective. If the brief looks interesting, we'll say yes quickly."],
```

---

### WEBSITE > `direct_sales` > `creative_pro` > friendly

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Take a look at the work. If something clicks, reach out.", "No formality required — just tell us about what you're building."],
["Browse the portfolio and see if we're thinking the same way.", "New project inquiries are always welcome."],
...
### WEBSITE > `direct_sales` > `creative_pro` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Review our portfolio and submit a project inquiry.", "We respond within two business days with a written proposal."],
...
["Explore the portfolio and arrange a consultation.", "All engagements begin with a discovery conversation. Written proposals provided."],
...
### WEBSITE > `lead_gen` > `creative_pro` > bold
...
### WEBSITE > `lead_gen` > `creative_pro` > friendly
...
### WEBSITE > `lead_gen` > `creative_pro` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Submit a project inquiry and we will respond with a written proposal within two business days.", "We provide fixed-fee proposals for all new engagements."],
...
["Send project details to receive a written scope and cost estimate.", "We take on a limited number of new clients each quarter."],
["Submit a project inquiry and we will follow up within two business days.", "All proposals include a full scope of work, timeline, and fixed fee."],
...
### WEBSITE > `audience_growth` > `creative_pro`

**Shapes for `creative_pro` audience_growth:**
- **Studio access (S):** see work as it develops — in-progress shots, decisions being made, not just the finished piece
- **Case study/outcome (C):** when a project ships, what happened, what it solved
- **Process/thinking (P):** how they approach problems, what they care about, decisions made along the way
- **Industry perspective (I):** what's good, what's wrong, what's changing in the field
- **Behind-the-release (R):** the story after a project launches — client outcome, what they'd do differently

#### bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8 (shapes: S, C+R, S+P, C, P):**
```
...
["Follow along. New work posted as projects ship.", "Process notes included. Not just the final result."],
...
**New pairs 4–8 (shapes: C+P, S+I, P+I, C, I+P):**
```
...
["Sign up for our newsletter to follow new work and read our thinking as it develops.", "We publish when there's something substantive to say."],
...
### WEBSITE > `retention` > `creative_pro`

_Existing pairs 1–3 unchanged._

**New pairs 4–6:**
```
["Ready for the next project?", "We keep all previous work on file. Easy to pick up where we left off."],
...
### EMAIL > `direct_sales` > `creative_pro` > bold
...
["Send the scope and I'll tell you if we're the right fit.", "Quick response, always."],
...
### EMAIL > `direct_sales` > `creative_pro` > friendly
...
### EMAIL > `direct_sales` > `creative_pro` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Please reply with your project scope and timeline. Proposal in two business days.", "All proposals include a full scope of work and fixed fee."],
...
["Please reply with your scope, objectives, and timeline.", "We will follow up to schedule a discovery call and provide a written proposal."],
...
### EMAIL > `lead_gen` > `creative_pro` > bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Reply with the brief. Honest read by tomorrow.", "Now booking new projects."],
...
### EMAIL > `lead_gen` > `creative_pro` > friendly
...
### EMAIL > `lead_gen` > `creative_pro` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Please reply with your project scope and timeline. Proposal in two business days.", "All proposals include scope of work, timeline, and a fixed fee."],
...
["Please reply with your project overview and we will respond with a written proposal within two business days.", "We take on a limited number of new engagements each quarter."],
["Reply to begin the inquiry process.", "We will confirm receipt and schedule a discovery call within two business days."],
```

---

### EMAIL > `audience_growth` > `creative_pro`
...
["Ready for the next project? Hit reply.", "We give existing clients priority on timeline."],
...
## Industry: `professional_svc`

Register: **expertise, clarity, trust, confidentiality, "we talk like humans."**
Bold: action-forward, directness signals confidence ("one free call, clear answers").
Friendly: accessible expertise, "no jargon" positioning, "you'll leave the first call knowing more than you came in with."
Professional: formal but not cold — structures the engagement clearly without bureaucratic distance.

---

### WEBSITE > `direct_sales` > `professional_svc` > bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Book a free consultation.", "We'll tell you exactly where you stand. No runaround."],
...
### WEBSITE > `direct_sales` > `professional_svc` > friendly
...
["Reach out and we'll find a time.", "We're straightforward people. You'll leave the first call knowing more than you did."],
...
### WEBSITE > `direct_sales` > `professional_svc` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Schedule a complimentary consultation.", "We provide clear guidance on your situation before any engagement begins. All discussions are confidential."],
["Book an initial consultation at no charge.", "All consultations are strictly confidential and without obligation."],
...
### WEBSITE > `lead_gen` > `professional_svc` > bold
...
### WEBSITE > `lead_gen` > `professional_svc` > friendly

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Book a free call and let's talk through what's going on.", "We'll give you an honest read on where things stand."],
["Reach out and we'll find a time.", "We're easy to talk to and we give straight answers."],
...
### WEBSITE > `lead_gen` > `professional_svc` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Schedule a complimentary consultation.", "All consultations are confidential. We provide clear guidance on next steps before any commitment."],
["Request an initial consultation to discuss your situation.", "We respond within one business day. All discussions remain strictly confidential."],
...
### WEBSITE > `audience_growth` > `professional_svc`

**Shapes for `professional_svc` audience_growth:**
- **Plain-language guidance (P):** "we explain the complicated stuff so you don't have to"
- **Issue tracking (I):** when something changes that affects you or your business
- **What-I'd-do (W):** decision-based content framed as practical, specific advice
- **Before-you-need-us (B):** follow now so when the moment arrives they know exactly who to call
- **Trust-building (T):** consistent, useful content that establishes authority over time
...
**New pairs 4–8 (shapes: W, P, T, P+W, I):**
```
...
**New pairs 4–8 (shapes: I, P+I, W, I, T):**
```
...
### WEBSITE > `retention` > `professional_svc`
...
["Ready to take the next step? Let's schedule a follow-up call.", "We keep your history on file — no need to start from scratch."],
```

---

### EMAIL > `direct_sales` > `professional_svc` > bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Reply and I'll set up a call this week.", "First consultation is free. I give real answers."],
["Hit reply and we'll sort it out.", "Tell me what's going on. I'll tell you what I'd do."],
["Reply with your situation and I'll give you an honest read.", "Straight answer, fast response."],
["Reply and I'll book the call.", "You'll leave the first conversation knowing exactly what to do next."],
["Reply and I'll set up a free consult.", "Clear answers. No jargon. First call is on me."],
```

---

### EMAIL > `direct_sales` > `professional_svc` > friendly

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Reply with a quick summary of what's going on.", "I'll give you an honest read and we'll figure out next steps together."],
...
### EMAIL > `direct_sales` > `professional_svc` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Please reply with a brief summary of your situation and we will respond within one business day.", "All initial consultations are complimentary and strictly confidential."],
["Reply to schedule a complimentary initial consultation.", "We will confirm timing and provide any preparatory information in advance."],
...
["Please reply with context on your situation and preferred contact times.", "We will respond within one business day with next steps."],
...
### EMAIL > `lead_gen` > `professional_svc` > bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Reply with your situation in a few sentences.", "I'll tell you honestly what I'd do. First conversation is free."],
["Hit reply and I'll get back to you today.", "Clear answers, fast. No jargon."],
["Send the overview and I'll reply with next steps.", "We give real answers, not qualified maybes."],
...
### EMAIL > `lead_gen` > `professional_svc` > friendly

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Reply with what's going on and I'll share an honest read.", "No obligation. Just a helpful conversation."],
...
### EMAIL > `lead_gen` > `professional_svc` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Please reply with a brief summary of your situation.", "We will respond with recommended next steps within one business day. All info stays confidential."],
...
["Please reply with a description of your situation and preferred contact times.", "We will respond within one business day with available consultation times."],
["Reply to schedule a complimentary consultation.", "We provide clear guidance on next steps without obligation. All discussions are confidential."],
```

---

### EMAIL > `audience_growth` > `professional_svc`
...
### EMAIL > `retention` > `professional_svc`
...
["Ready to take the next step? Reply and I'll pull up your file.", "We'll review where things stand and figure out what's next."],
...
Register: **belonging, purpose, collective action, impact.**
Bold: urgency of the cause, "we need people like you" — never transactional efficiency.
Friendly: inviting and warm, "there's a place for everyone," no prior experience required.
Professional: organized, program-based, capacity-matched, institutional-partner ready.

> Note: The existing bank pair `"Support the work. Volunteer or give, your call.", "It takes about 30 seconds."` is flagged in §12 of the audit as off-register (transactional efficiency language borrowed from retail). This should be replaced via a follow-on Wave A pass for this industry. The new pairs below establish the correct register for the depth expansion.

---

### WEBSITE > `direct_sales` > `community` > bold

_Existing pairs 1–3 unchanged (pair 3 flagged for register fix — see note above)._
...
### WEBSITE > `direct_sales` > `community` > friendly

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Come find out how you can get involved.", "There's a place for everyone here."],
["Join us and see what we're building together.", "Every person who shows up makes the work more possible."],
["Get involved in a way that makes sense for your life.", "Volunteer or donate — both matter, and we'll figure out the best fit."],
...
### WEBSITE > `direct_sales` > `community` > professional
...
["Review our programs and submit an involvement inquiry.", "We match contributors with opportunities based on availability, capacity, and interest."],
...
### WEBSITE > `lead_gen` > `community` > bold
...
["Tell us how you'd like to help.", "Volunteer, donate, advocate — we'll figure out the best fit together."],
...
### WEBSITE > `lead_gen` > `community` > friendly
...
### WEBSITE > `lead_gen` > `community` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Submit a volunteer or organizational partnership inquiry.", "We respond within two business days with program information and next steps."],
...
["Request information on our volunteer programs, giving initiatives, or partnership opportunities.", "All inquiries receive a personal response within two business days."],
...
### WEBSITE > `audience_growth` > `community`

**Shapes for `community` audience_growth:**
- **Impact story (I):** what the work actually accomplishes in the world — real outcomes, real people
- **Behind-the-work (B):** who is doing it, what their days look like, the human face of the mission
- **Event/opportunity (E):** upcoming ways to participate, volunteer slots, fundraisers
- **Progress/accountability (A):** honest reporting on how the organization is doing against its goals
- **Stay-close (S):** follow to feel connected to the cause even before you're directly involved

#### bold

_Existing pairs 1–3 unchanged._

**New pairs 4–8 (shapes: I, S, A, B, I+A):**
```
...
["Follow along and see the impact.", "We post real stories and real results from the work every week."],
```
...
**New pairs 4–8 (shapes: B, I+E, S, I+B, S+I):**
```
["Follow along and see what we're building together.", "Real updates from the people doing the work."],
...
["Subscribe and stay close to the work, even if you're not involved yet.", "We share real stories from real people making a difference."],
...
**New pairs 4–8 (shapes: A+I, I+E, I+E+A, A, I+E+B):**
```
...
["Sign up for our newsletter to stay current on community initiatives and organizational impact.", "Impact reports, event notices, and ways to get involved, monthly."],
...
["Come back and see what's changed.", "The work is bigger now. There's a place for you in it."],
["Ready to re-engage?", "Reach out and we'll find the best way to bring you back in."],
```

---

### EMAIL > `direct_sales` > `community` > bold
...
["Hit reply and tell me you're in.", "I'll take it from there and match you with the right program."],
```

---

### EMAIL > `direct_sales` > `community` > friendly
...
### EMAIL > `direct_sales` > `community` > professional

_Existing pairs 1–3 unchanged._

**New pairs 4–8:**
```
["Please reply with your interest area and we will respond with available programs within two business days.", "We welcome individual volunteers, organizational partners, and donors."],
...
["Please reply with your area of interest.", "We will respond within two business days with available programs and next steps."],
["Reply to this email and we will connect you with the appropriate program coordinator.", "We welcome all forms of contribution and will find the right fit."],
```

---

### EMAIL > `lead_gen` > `community` — NEW SECTION
...
### EMAIL > `audience_growth` > `community`
...
### EMAIL > `retention` > `community`

_Existing pairs 1–3 unchanged._

**New pairs 4–6:**
```
["Ready to get back in? Reply and we'll find the right fit for where you are now.", "There's always more work to do. We'd love to have you back."],
...
| Industry | Surface | Goal | Tones × new pairs | New pairs |
|---|---|---|---|---:|
| `retail_maker` | WEBSITE | direct_sales (3 tones) | 3 × 5 | 15 |
| `retail_maker` | WEBSITE | lead_gen (3 tones) | 3 × 5 | 15 |
| `retail_maker` | WEBSITE | audience_growth (3 tones) | 3 × 5 | 15 |
| `retail_maker` | WEBSITE | retention | 1 × 3 | 3 |
| `retail_maker` | EMAIL | direct_sales (3 tones) | 3 × 5 | 15 |
| `retail_maker` | EMAIL | lead_gen (3 tones) **NEW** | 3 × 8 | 24 |
| `retail_maker` | EMAIL | audience_growth | 1 × 3 | 3 |
| `retail_maker` | EMAIL | retention | 1 × 3 | 3 |
| **Subtotal `retail_maker`** | | | | **93** |
| `health_wellness` | WEBSITE | direct_sales (3 tones) | 3 × 5 | 15 |
| `health_wellness` | WEBSITE | lead_gen (3 tones) | 3 × 5 | 15 |
| `health_wellness` | WEBSITE | audience_growth (3 tones) | 3 × 5 | 15 |
| `health_wellness` | WEBSITE | retention | 1 × 3 | 3 |
| `health_wellness` | EMAIL | direct_sales (3 tones) | 3 × 5 | 15 |
| `health_wellness` | EMAIL | lead_gen (3 tones) | 3 × 5 | 15 |
| `health_wellness` | EMAIL | audience_growth | 1 × 3 | 3 |
| `health_wellness` | EMAIL | retention | 1 × 3 | 3 |
| **Subtotal `health_wellness`** | | | | **84** |
| `creative_pro` | WEBSITE | direct_sales (3 tones) | 3 × 5 | 15 |
| `creative_pro` | WEBSITE | lead_gen (3 tones) | 3 × 5 | 15 |
| `creative_pro` | WEBSITE | audience_growth (3 tones) | 3 × 5 | 15 |
| `creative_pro` | WEBSITE | retention | 1 × 3 | 3 |
| `creative_pro` | EMAIL | direct_sales (3 tones) | 3 × 5 | 15 |
| `creative_pro` | EMAIL | lead_gen (3 tones) | 3 × 5 | 15 |
| `creative_pro` | EMAIL | audience_growth | 1 × 3 | 3 |
| `creative_pro` | EMAIL | retention | 1 × 3 | 3 |
| **Subtotal `creative_pro`** | | | | **84** |
| `professional_svc` | WEBSITE | direct_sales (3 tones) | 3 × 5 | 15 |
| `professional_svc` | WEBSITE | lead_gen (3 tones) | 3 × 5 | 15 |
| `professional_svc` | WEBSITE | audience_growth (3 tones) | 3 × 5 | 15 |
| `professional_svc` | WEBSITE | retention | 1 × 3 | 3 |
| `professional_svc` | EMAIL | direct_sales (3 tones) | 3 × 5 | 15 |
| `professional_svc` | EMAIL | lead_gen (3 tones) | 3 × 5 | 15 |
| `professional_svc` | EMAIL | audience_growth | 1 × 3 | 3 |
| `professional_svc` | EMAIL | retention | 1 × 3 | 3 |
| **Subtotal `professional_svc`** | | | | **84** |
| `community` | WEBSITE | direct_sales (3 tones) | 3 × 5 | 15 |
| `community` | WEBSITE | lead_gen (3 tones) | 3 × 5 | 15 |
| `community` | WEBSITE | audience_growth (3 tones) | 3 × 5 | 15 |
| `community` | WEBSITE | retention | 1 × 3 | 3 |
| `community` | EMAIL | direct_sales (3 tones) | 3 × 5 | 15 |
| `community` | EMAIL | lead_gen (3 tones) **NEW** | 3 × 8 | 24 |
| `community` | EMAIL | audience_growth | 1 × 3 | 3 |
| `community` | EMAIL | retention | 1 × 3 | 3 |
| **Subtotal `community`** | | | | **93** |
| **WAVE C TOTAL** | | | | **438** |

---

_Apply after Wave B. Wave D covers Social Casual surfaces (Instagram, TikTok, Facebook) × `direct_sales`, `lead_gen`, and `retention` for all seven industries._
